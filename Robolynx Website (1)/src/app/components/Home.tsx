...
export default function Home() {
  ...
  return (
    <div className="w-full bg-[#0a1929] overflow-x-hidden">
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 z-50 px-8 py-6 flex items-center justify-between bg-[#0a1929]/80 backdrop-blur-sm">
        <motion.div
        ...
        >
          <img src={logo} alt="Robolynx Logo" className="h-16 w-auto" />
          <span className="text-white font-bold text-2xl tracking-wider">Robolynx</span>
        </motion.div>
        ...
        >
          <button 
            ...
            className="text-white/90 hover:text-white transition-colors text-sm font-medium hover:scale-105 transition-transform"
          >
            About Us
          </button>
          <Link 
      ...
      <section className="relative h-screen w-full overflow-hidden">
        ...
        >
          <h1 className="text-white text-6xl md:text-7xl lg:text-8xl tracking-tight text-center whitespace-nowrap" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
            10907 Robolynx
          </h1>
        </motion.div>
      ...
      {/* Who Are We Section */}
      <section id="about-us" className="w-full pt-10 pb-6 px-8 bg-[#0a1929] scroll-mt-24">
        <motion.div
      ...
      <section className="w-full pt-6 pb-6 px-8 bg-[#0a1929]">
        <motion.div
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
      ...
      <section id="projects" className="w-full pt-6 pb-6 px-8 bg-[#0a1929] scroll-mt-24">
        <motion.div
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
      ...
      {/* Awards Section */}
      <section id="awards" className="w-full pt-6 pb-6 px-8 bg-[#0a1929] scroll-mt-24">
        <motion.div
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
      ...
      <section id="competitions" className="w-full pt-6 pb-6 px-8 bg-[#0a1929] scroll-mt-24">
        <motion.div
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
